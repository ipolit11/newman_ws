...
class Face_Detector
{
  ...
  face_tracker_control_newman::centroid face_centroid;
...
public:
  ...
  haar_file_face = "/home/robot/newman_ws/src/face_tracker_newman/data/face.xml";
  face_tracking = 1;
  ...
  catch(int e)
  {
    ...
    face_centroid_pub = nh_.advertise<face_tracker_control_newman::centroid>("/face_centroid",10);
...
void detectAndDraw( Mat& img, CascadeClassifier& cascade)
{
    ...
    line(img,  pt3,  pt4, Scalar(0, 255, 0), 1);
    line(img,  pt5,  pt6, Scalar(0, 255, 0), 1);


    putText(img, "left", cvPoint(50,240), FONT_HERSHEY_SIMPLEX, 1, cvScalar(255,0,0), 2, LINE_AA);
    putText(img, "center", cvPoint(280,240), FONT_HERSHEY_SIMPLEX, 1, cvScalar(0,0,255), 2, LINE_AA);
    putText(img, "right", cvPoint(480,240), FONT_HERSHEY_SIMPLEX, 1, cvScalar(255,0,0), 2, LINE_AA);
